...
<<<<<<< HEAD
=======
#load all libraries/packages here
>>>>>>> 5a1726c6982319c19b101256defc337af0274790
...
cars$speed
=======
#note: use the sweep function to clear r env of past variables
cars$speed
class(car$speed)
>>>>>>> 5a1726c6982319c19b101256defc337af0274790
```
...
=======
summary(df) #will also show number of NAs if applicable
head(df) #show the first 6 rows of df
tail(df)
>>>>>>> 5a1726c6982319c19b101256defc337af0274790
